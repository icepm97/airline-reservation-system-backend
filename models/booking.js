...
const create = async (customer_id, date, flight_id, tickets, customer) => {
    ...
    try {
        ...
        if (!customer_id) {
            const { rows } = await client.query('INSERT INTO "booking" ("booked", "first_name", "last_name", "gender", "birthday", "NIC", "country", "category") VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING "customer_id"', [customer.email, customer.first_name, customer.last_name, 'male', '2000-00-00', '000000000', customer.country,'guest'])
        }
